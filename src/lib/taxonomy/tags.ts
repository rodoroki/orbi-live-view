...
export const TAGS: Tag[] = [
  ...
  { id: "ash", slug: "ash", name: { en: "Ash", "pt-BR": "Cinzas", es: "Ceniza" } },
  {
    id: "eruption",
    slug: "eruption",
    name: { en: "Eruption", "pt-BR": "Erupção", es: "Erupción" },
  },
  {
    id: "aftershock",
    slug: "aftershock",
    name: { en: "Aftershock", "pt-BR": "Réplica", es: "Réplica" },
  },
  {
    id: "heavy-rain",
    slug: "heavy-rain",
    name: { en: "Heavy Rain", "pt-BR": "Chuva Forte", es: "Lluvia Fuerte" },
  },
  {
    id: "strong-wind",
    slug: "strong-wind",
    name: { en: "Strong Wind", "pt-BR": "Vento Forte", es: "Viento Fuerte" },
  },
  {
    id: "high-waves",
    slug: "high-waves",
    name: { en: "High Waves", "pt-BR": "Ondas Altas", es: "Olas Altas" },
  },
  { id: "drought", slug: "drought", name: { en: "Drought", "pt-BR": "Seca", es: "Sequía" } },
  {
    id: "heatwave",
    slug: "heatwave",
    name: { en: "Heatwave", "pt-BR": "Onda de Calor", es: "Ola de Calor" },
  },
  {
    id: "coldwave",
    slug: "coldwave",
    name: { en: "Coldwave", "pt-BR": "Onda de Frio", es: "Ola de Frío" },
  },
  {
    id: "tropical",
    slug: "tropical",
    name: { en: "Tropical", "pt-BR": "Tropical", es: "Tropical" },
  },
  ...
  { id: "land", slug: "land", name: { en: "Land", "pt-BR": "Terrestre", es: "Terrestre" } },
  {
    id: "atmospheric",
    slug: "atmospheric",
    name: { en: "Atmospheric", "pt-BR": "Atmosférico", es: "Atmosférico" },
  },
  {
    id: "climate",
    slug: "climate",
    name: { en: "Climate", "pt-BR": "Climático", es: "Climático" },
  },
